...
namespace cheat
{
	...
	extern void GlowAndTrigger(KeyListener&, ColorRGBA colors, bool fullBloom, int glowStyle, bool healthBased, bool rainbow, bool paintBlack, remote::Handle* csgo, remote::MapModuleMemoryRegion* client);
